...
export default function Footer(){
    ...
    const openMap = ()=>{
        window.open("https://www.google.com.ar/maps/place/C.+116+752,+Mercedes,+Provincia+de+Buenos+Aires/@-34.6665633,-59.4383424,230m/data=!3m1!1e3!4m5!3m4!1s0x95bc731ab794f239:0xaaa377d4b3bec8d8!8m2!3d-34.6665112!4d-59.438649?coh=164777&entry=tt&shorturl=1")
    }
    ...
    return(
        <div className="nav-footer flex flex-col w-full items-center pt-10 pb-6">
            ...
            <div className="section-bottom grid grid-cols-2 w-4/5 gap-4 my-4
            md:flex justify-between
            ">
                <div className="flex">
                    <img className="w-5 h-6 mr-1" src={location}/>
                        <label className="cursor-pointer underline"
                        onClick={openMap}>Calle 114 entre 29 / 31</label>
                </div>
            ...
            <div className="section-bottom w-4/5 flex justify-between">
                <div>
                    <p>Creada por alumnos de 
                        <label className="lighter-blue cursor-pointer" onClick={openHenry}> Soy Henry</label>
                    </p>
                </div>
                ...
                <div className="flex">
                    ...
                    <div className="ml-2">
                        <img className="w-8 cursor-pointer" src={ig} alt="instagram"
                        onClick={openIg}/>
                    </div>
                </div>
            </div>
